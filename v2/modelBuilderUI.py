...
class ModuleUI:
    ...
    def _createFile(self):
        ...
        with open(fr"{directory}/{self.modelName}_model.py", "w") as f:
            ...
            for cmd in self.varAllLayerCommand:
                f.write("\t")
                f.write(cmd + "\n")
    ...
    def _removeLayer(self):
        ...
        self.varAllLayerCommand.pop(self.chosenLayerId - 1)
    ...
    def Conv2D(self, chosenLayer):
        ...
        curseId = self.listBox.curselection()[0]
        try:
            filters = 0
            ...
            if not filters == 0:
                ...
                try:
                    ...
                    self.varConv2DNum += 1
                    self.allLayerNum += 1
                    self.listBox.insert(curseId + 1, command)
                    ...
                    self.varAllLayerCommand.append(command)
                    print(command)
                except ValueError:
